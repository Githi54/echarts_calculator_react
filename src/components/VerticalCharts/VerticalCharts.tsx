...
export const VerticalCharts: React.FC<Props> = ({
  storageCount,
  transferCount,
}) => {
  ...
  function getColors(
    ...
    backblaze === minPrice
      ? setBackblazeColor("red")
      : setBackblazeColor("gray");
    bunny === minPrice ? setBunnyColor("orange") : setBunnyColor("gray");
    scaleway === minPrice
      ? setScalewayColor("violet")
      : setScalewayColor("gray");
  ...
  return (
    <Container>
      ...
      <Box sx={{display: "flex", width: "min-content", position: "relative", left: "12rem" }}>
        <Box
          sx={{
            display: "flex",
